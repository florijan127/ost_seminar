...
x_train_path = "X_estimation.csv"
y_train_path = "y_estimation.csv"
x_test_path = "X_estimation.csv"
y_test_path = "y_estimation.csv"
...
train_loader, test_loader = prepare_dataloaders(x_train_path, y_train_path, x_test_path, y_test_path)
...
torch.save(model.state_dict(), "estimation_model.pth")